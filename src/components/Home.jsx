...
const Home = () => {
  ...
  useEffect(() => {
    const hasValidState = country && stateKey;
    const hasCities =
      hasValidState && countries[country].states[stateKey].length > 0;
      ...
      const dataCards = await Promise.all(
        citiesList.map(async (city, index) => {
          ...
          try {
            ...
            return {
              id: index,
              shortCode: city.slice(0, 2).toUpperCase(),
              city,
    ...
    <div className="font-sans m-0 p-0 box-border">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mt-10 px-4">
        ...
        <div className="flex flex-col w-[600px] max-w-full">
          <label htmlFor="country" className="mb-2 text-base font-medium">
            Select Country
          </label>
          <select
            id="country"
        ...
        {/* State Selector */}
        <div className="flex flex-col w-[600px] max-w-full">
          <label htmlFor="state" className="mb-2 text-base font-medium">
            Select State
          </label>
          <select
            id="state"
